...
import { renderAgents, renderAgentSessions } from "./views/agents.ts";
...
import { renderVizDemo } from "./views/viz-demo.ts";
import "./components/connection-indicator.ts";
  ...
  return html`
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${state.tab === "agents" ? renderAgentSessions() : nothing}
